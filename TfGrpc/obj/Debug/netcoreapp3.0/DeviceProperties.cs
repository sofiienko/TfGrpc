    ...
    static DevicePropertiesReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dGllc0JZQhZEZXZpY2VQcm9wZXJ0aWVzUHJvdG9zWjxnaXRodWIuY29tL3Rl",
            "bnNvcmZsb3cvdGVuc29yZmxvdy90ZW5zb3JmbG93L2dvL2NvcmUvcHJvdG9i",
            "dWb4AQFiBnByb3RvMw=="));
  ...
  public sealed partial class NamedDevice : pb::IMessage<NamedDevice> {
    ...
    public void MergeFrom(NamedDevice other) {
      ...
      if (other.properties_ != null) {
        if (properties_ == null) {
          Properties = new global::Tensorflow.DeviceProperties();
        }
