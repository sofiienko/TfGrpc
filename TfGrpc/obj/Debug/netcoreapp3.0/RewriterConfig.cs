...
namespace Tensorflow {
  ...
  public sealed partial class RewriterConfig : pb::IMessage<RewriterConfig> {
    ...
    private global::Tensorflow.RewriterConfig.Types.Toggle implementationSelector_ = 0;
    /// <summary>
    ...
    private global::Tensorflow.RewriterConfig.Types.Toggle autoMixedPrecision_ = 0;
    /// <summary>
    ...
    public override int GetHashCode() {
      ...
      if (ImplementationSelector != 0) hash ^= ImplementationSelector.GetHashCode();
      if (AutoMixedPrecision != 0) hash ^= AutoMixedPrecision.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ImplementationSelector != 0) {
        output.WriteRawTag(176, 1);
        output.WriteEnum((int) ImplementationSelector);
      }
      if (AutoMixedPrecision != 0) {
    ...
    public void MergeFrom(RewriterConfig other) {
      ...
      if (other.ImplementationSelector != 0) {
        ImplementationSelector = other.ImplementationSelector;
      }
      if (other.AutoMixedPrecision != 0) {
